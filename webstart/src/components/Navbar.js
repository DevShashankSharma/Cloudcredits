...
function Navbar({ isDarkMode, toggleDarkMode }) {
    ...
    return (
        <nav
            className={`p-4 fixed flex justify-center w-full transition-transform duration-300 ${isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-900'} ${isVisible ? 'translate-y-0' : '-translate-y-full'} z-10`}
        >
