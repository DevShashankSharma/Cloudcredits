...
import TemplatePreview from '../image/TemplatePreview.png'
import assestManage from '../image/assetsManage.png'
        ...
        >
            ...
            <div className="mt-12">
                ...
                >
                    ...
                    <img src={TemplatePreview} alt="Template Preview" className="mt-4 w-full rounded-lg shadow-lg" />
                </motion.div>
            </div>
        </motion.section>
        ...
        >
            ...
            <div className="mt-12">
                ...
                >
                    ...
                    <img src={seo} alt="SEO Optimization" className="mt-4 w-full rounded-lg shadow-lg" />
                </motion.div>
                ...
                >
                    ...
                    <img src={assestManage} alt="Performance Tips" className="mt-4 w-full rounded-lg shadow-lg" />
                </motion.div>
            </div>
        </motion.section>
    </motion.div>
