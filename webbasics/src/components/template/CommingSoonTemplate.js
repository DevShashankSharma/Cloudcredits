            ...
            <div className="max-w-6xl mx-auto text-center text-white relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg">
                        ...
                        <p>Take advantage of exclusive offers and discounts on premium templates for early adopters.</p>
                    </div>
                    ...
                    <div className="bg-white text-gray-800 p-6 rounded-lg shadow-lg">
                        ...
                        <h3 className="text-2xl font-semibold mb-3">Detailed Documentation</h3>
                        <p>Each template will come with detailed documentation to help you get started quickly and efficiently.</p>
                    </div>
                </div>

                <Link
                    to="*"
                    className="inline-flex items-center px-6 py-3 rounded-lg bg-yellow-500 text-black font-semibold hover:bg-yellow-600 transition-colors"
                >
                    <span className="mr-2">See More Updates</span>
                    <FiArrowRight />
                </Link>
            </div>
        </div>
