...
function Header() {
    ...
    return (
        <header
            ref={headerRef}
            className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-950 via-purple-950 to-pink-950 text-white p-6 flex justify-between items-center shadow-lg transition-transform duration-300 opacity-85"
